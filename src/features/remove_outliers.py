...
from sqlalchemy import label  # pip install scikit-learn
...
dataset = mark_outliers_iqr(df, "acc_x")
col = "acc_x"
...
# Loop over all columns
dataset = mark_outliers_chauvenet(df, "acc_x")
col = "acc_x"
for col in outlier_columns:
...
for col in outlier_columns:
    for label in df["label"].unique():
           ...
           outlier_removal_df.loc[outlier_removal_df["label"] == label, col] = dataset[col]
           
        
# Export new dataframe
# --------------------------------------------------------------
outlier_removal_df.to_pickle("../../data/interim/data_outliers_removed_chauvenet.pkl")